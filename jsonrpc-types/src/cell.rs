...
///
/// ```
/// # serde_json::from_str::<ckb_sdk_jsonrpc_types::CellWithStatus>(r#"
/// {
///   "cell": {
///     "data": {
...
///
/// ```
/// # serde_json::from_str::<ckb_sdk_jsonrpc_types::CellInfo>(r#"
/// {
///   "data": {
///     "content": "",
///     "hash": "0x28e83a1277d48add8e72fadaa9248559e1b632bab2bd60b27955ebc4c03800a5"
...
///
/// ```
/// # serde_json::from_str::<ckb_sdk_jsonrpc_types::CellData>(r#"
/// {
///   "content": "",
///   "hash": "0x28e83a1277d48add8e72fadaa9248559e1b632bab2bd60b27955ebc4c03800a5"
/// }
