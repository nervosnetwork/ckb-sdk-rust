...
mod tests {
    ...
    fn simple_encode() {
        ...
        assert_eq!(request, BytesMut::from("{ test: 1 }"));
    }
    ...
    fn escape() {
        ...
        assert_eq!(request, BytesMut::from(r#"{ test: "\"\\" }"#));
        ...
        assert_eq!(request3, BytesMut::from(r#"{ test: "\}" }"#));
    }
    ...
    fn fragmented_encode() {
        ...
        assert_eq!(request, BytesMut::from("{ test: 3 }"));
    }
    ...
    fn simple_line_codec() {
        ...
        assert_eq!(request, BytesMut::from("{ test: 1 }"));
        assert_eq!(request2, BytesMut::from("{ test: 2 }"));
    }
}
